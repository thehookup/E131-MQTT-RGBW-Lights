...
#define MQTT_CLIENT_NAME    "B1_1" //This name will be used for all MQTT Messages
...
void fireLight()
{
      int delayValue = random(2, 100);
      int whiteFire = random(1,10);
      delay(delayValue);
      _my92xx.setChannel(5, 0); 
      _my92xx.setChannel(4, 255);
      _my92xx.setChannel(3, 0);
      _my92xx.setChannel(1, 0);    
      _my92xx.setChannel(1, whiteFire/2); 
      _my92xx.setState(true);
      _my92xx.update();
      ...
      if(delayValue > 50 && whiteFire > 5)
      {
        _my92xx.setChannel(3, whiteFire*5); 
      }
      _my92xx.setState(true);
      _my92xx.update();    
}
